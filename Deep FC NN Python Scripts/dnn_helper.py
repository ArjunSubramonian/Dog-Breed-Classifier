...
# All the functions required to build a deep neural network.
...
# The initialization for a deeper L-layer neural network.
...
def L_model_forward(X, parameters):
    ...
    caches = []
    A = X
    L = len(parameters) // 2                  # number of layers in the neural network, integer division
...
# Now you have a full forward propagation that takes the input X and outputs a row vector containing your predictions. It also records all intermediate values in "caches". Now, you can compute the cost of your predictions.
